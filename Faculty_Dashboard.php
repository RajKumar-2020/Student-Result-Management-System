...
<body id="body-pd">
    ...
    <h3 style="color:white; background-color:green;font-weight: bold;height: 50px;margin-top:10px;">FACULTY DASHBOARD</h3><br><br>
        <div class="container">
        <h5 style="margin:10px; text-algin:center;">PERSONAL INFO</h5>
        <?php
