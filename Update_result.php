...
<body id="body-pd">
    ...
    <h3 style="color:white; background-color:green;font-weight: bold;height: 50px;margin-top:10px;">PLEASE ENTER DETALS FOR UPDATING RESULT</h3><br><br>
        
        <div class="container">
        <?php 
                $subject1= $subject2 =$subject3= $subject4= $subject5= $subject6 =$s1marks= $s2marks= $s3marks= $s4marks =$s5marks =$s6marks ="";
                $gmarks1=$gmarks2=$gmarks3=$gmarks4=$gmarks5=$gmarks6="";
                ...
                { 
                    ...
                    $sql ="SELECT s.*,r.*  FROM  subject s , result r  where  s.semester =r.semester and s.semester = '$sem' and r.RollNo='$rollno' ";
                    $result = mysqli_query($con,$sql);
                    while($row = mysqli_fetch_assoc($result))
                    {
               ...
               if(!empty($_POST['Submit']))
                {
                    ...
                    $rollno = $_POST['roll'];
                    $sem    = $_POST['sem'];
                    $sql = "UPDATE `result` SET `sgmarks1` = '$marks1', `sgmarks2` = '$marks2', `sgmarks3` = '$marks3', `sgmarks4` = '$marks4', `sgmarks5` = '$marks5', `sgmarks6` = '$marks6' WHERE `result`.`RollNo` = $rollno";
                    $result1=mysqli_query($con,$sql);
                    if($result1)
                    {
                        echo"<h3 style ='color:#66ff33;'>Result Updated Successfully!</h3>";
                    }
                }
                }
...
?>
<div id="add">
          <form action="/practise/Update_result.php" method="POST">
        ...
        <?php
                    ...
                    echo"<h5>Please Update Marks</h5>";
                    echo"<form action='/practise/Update_result.php'onsubmit='return marks()' method='POST'>";
